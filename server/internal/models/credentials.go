...
func (o *Credential) GetUser() *User {
	if o == nil {
		return nil
	}
...
func (credentialL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCredential any, mods queries.Applicator) error {
...
func (o *Credential) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	values := []any{related.ID, o.CredID}
