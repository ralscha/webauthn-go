...
type Credential struct {
	...
	CredPublicKey  []byte    `boil:"cred_public_key" json:"cred_public_key" toml:"cred_public_key" yaml:"cred_public_key"`
...
var CredentialTableColumns = struct {
	...
	CredPublicKey:  "credentials.cred_public_key",
...
var CredentialWhere = struct {
	...
	CredPublicKey  whereHelper__byte
	...
	CredPublicKey:  whereHelper__byte{field: "\"credentials\".\"cred_public_key\""},
	UserID:         whereHelperint{field: "\"credentials\".\"user_id\""},
	WebauthnUserID: whereHelper__byte{field: "\"credentials\".\"webauthn_user_id\""},
	Counter:        whereHelperint{field: "\"credentials\".\"counter\""},
	CreatedAt:      whereHelpernull_Time{field: "\"credentials\".\"created_at\""},
...
var (
	credentialAllColumns            = []string{"cred_id", "cred_public_key", "user_id", "webauthn_user_id", "counter", "created_at", "last_used"}
	credentialColumnsWithoutDefault = []string{"cred_id", "cred_public_key", "user_id", "webauthn_user_id", "counter"}
	credentialColumnsWithDefault    = []string{"created_at", "last_used"}
