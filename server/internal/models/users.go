...
func (o *User) GetCredentials() CredentialSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCredentials()
}
...
func (userL) LoadCredentials(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
