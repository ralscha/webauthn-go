...
type AppCredential struct {
	...
	Transports      null.String `boil:"transports" json:"transports,omitempty" toml:"transports" yaml:"transports,omitempty"`
	AaGUID          []byte      `boil:"aa_guid" json:"aa_guid" toml:"aa_guid" yaml:"aa_guid"`
...
var AppCredentialTableColumns = struct {
	...
	PublicKey:       "app_credentials.public_key",
	AttestationType: "app_credentials.attestation_type",
	Transports:      "app_credentials.transports",
	AaGUID:          "app_credentials.aa_guid",
	SignCount:       "app_credentials.sign_count",
}
...
var AppCredentialWhere = struct {
	...
	Transports      whereHelpernull_String
	...
	PublicKey:       whereHelper__byte{field: "\"app_credentials\".\"public_key\""},
	AttestationType: whereHelpernull_String{field: "\"app_credentials\".\"attestation_type\""},
	Transports:      whereHelpernull_String{field: "\"app_credentials\".\"transports\""},
	AaGUID:          whereHelper__byte{field: "\"app_credentials\".\"aa_guid\""},
	SignCount:       whereHelperint{field: "\"app_credentials\".\"sign_count\""},
}
...
var (
	appCredentialAllColumns            = []string{"id", "app_user_id", "public_key", "attestation_type", "transports", "aa_guid", "sign_count"}
	appCredentialColumnsWithoutDefault = []string{"id", "app_user_id", "public_key", "aa_guid", "sign_count"}
	appCredentialColumnsWithDefault    = []string{"attestation_type", "transports"}
